...
- **GitHub Pages**: https://louischen737.github.io/transmov-privacy/privacy-policy.html
- **Custom Domain**: https://yourdomain.com/privacy-policy.html (if configured)

## About TransMov

TransMov is a macOS application for video and animation processing, providing:

- **Animation Preview**: Preview and play APNG, GIF, and WebP animation files
- **Video Remove BG**: Convert videos to animations with AI-powered background removal
...
- **Email**: transmovfeedback@outlook.com
- **App Store**: Leave a review or contact us through the App Store
